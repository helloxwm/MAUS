...
We also found those \emph{rank stability islands} for medium-ranked taxa in the other periods belonging to the individual \emph{A} in the host lifestyle study \cite{hostlife} (see Supplementary Figure \ref{supfig:corrank_HLS_before} and Supplementary Figure \ref{supfig:corrank_HLS_after} for the corresponding rank plots). See Supplementary Table S8 for details about the rank and RSI for the above-mentioned taxa over the different periods considered.
